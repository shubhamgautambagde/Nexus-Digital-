...
const iconStyles = "w-8 h-8 text-brand-secondary";

export const LogoIcon = () => (
    <svg className="w-8 h-8 text-brand-primary" viewBox="0 0 24 24" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
...
const socialIconStyles = "w-6 h-6";

export const TwitterIcon = () => (
    <svg className={socialIconStyles} fill="currentColor" viewBox="0 0 24 24">
